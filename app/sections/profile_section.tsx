        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-xl">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6">
            ...
            <div className="flex items-center gap-5 text-cyan-800 dark:text-gray-300">
              ...
              <a href="https://www.linkedin.com/in/john-ivan-belaro-569b37407/" target="_blank" className="hover:text-[#0A66C2] transition-colors transform hover:scale-110" aria-label="LinkedIn">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
